...
GRANT USAGE ON AGENT IDENTIFIER('SF_AI_DEMO.DEMO_SCHEMA.SNOWFLAKE_DETECTIVE') TO ROLE IDENTIFIER('SF_INTELLIGENCE_DEMO');

ALTER SNOWFLAKE INTELLIGENCE IF EXISTS IDENTIFIER('SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT') ADD AGENT IDENTIFIER('SF_AI_DEMO.DEMO_SCHEMA.SNOWFLAKE_DETECTIVE');
